const authors = [
  ...
  },
  {
    ...
    bio:
      "I build, automate & sometimes rescue applications. If you have a project that you want to get started, think you need my help with something or just fancy saying hey, then get in touch.",
